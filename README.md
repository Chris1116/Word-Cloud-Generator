...
- Choose from four different shapes for the word cloud. (***generate any differnet shapes of word cloud*** whatever you want, as long as you should put the imag(shape).png you want to the static file.)
